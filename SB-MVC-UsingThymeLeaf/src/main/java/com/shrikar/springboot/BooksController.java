...
public class BooksController {
	...
	public String getBooks(HttpSession session) {
		...
		Book mybook1=new Book(101,"Master Spring Boot","Srinivas Dande",BigDecimal.valueOf(10000.0),"Java");
		Book mybook2=new Book(102,"Master MicroServices","SrinivasDande",BigDecimal.valueOf(10000.0),"JLC");
