...
public class CourseController {
	...
	@ApiOperation(value = " Adds Course Information",response = void.class,
			notes = "Adds Course Information" )
	...
	@ApiOperation(value = " Returns Course Information By Trainer Name",response = List.class,
			notes = " Returns Course Information By Trainer Name" )
	...
	@ApiOperation(value = " Returns Course Information By Cost",response = List.class,
			notes = " Returns Course Information By Cost" )
	...
	@ApiOperation(value = " Returns Course Information By Course Name",response = Course.class,
			notes = " Returns Course Information By Course Name" )
